...
class Scenario_hurt_1_left extends StatefulWidget {
  ...
  @override
  State<Scenario_hurt_1_left> createState() =>
      _Scenario_hurt_1_leftState();
}

class _Scenario_hurt_1_leftState
    extends State<Scenario_hurt_1_left> {
  @override
  void initState() {
    super.initState();
    _playWelcomeTTS();
  ...
  Future<void> _playWelcomeTTS() async {
    await tts.TextToSpeech(
        "여러분 반가워요! 이번 시간에는 집에서 다쳤을 때 어떻게 해야 하는지 알아볼 거에요. "
            "여러분은 다쳐본 적이 있나요? 그럴 때 어떻게 했나요?, 다쳤을 때에는 빠르게 응급조치를 해야 해요."
...
class Scenario_hurt_1_right extends StatefulWidget {
  ...
  @override
  State<Scenario_hurt_1_right> createState() =>
      _Scenario_hurt_1_rightState();
}

class _Scenario_hurt_1_rightState
    extends State<Scenario_hurt_1_right> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: Center(
