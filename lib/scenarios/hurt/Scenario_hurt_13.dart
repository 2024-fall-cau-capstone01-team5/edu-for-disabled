...
class Scenario_hurt_13_left extends StatefulWidget {
  ...
  @override
  State<Scenario_hurt_13_left> createState() => _Scenario_hurt_13_leftState();
}

class _Scenario_hurt_13_leftState extends State<Scenario_hurt_13_left> {
  void initState() {
    super.initState();
    _playWelcomeTTS();
  }
...
class Scenario_hurt_13_right extends StatefulWidget {
  ...
  @override
  State<Scenario_hurt_13_right> createState() => _Scenario_hurt_13_rightState();
}

class _Scenario_hurt_13_rightState extends State<Scenario_hurt_13_right> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: Center(
