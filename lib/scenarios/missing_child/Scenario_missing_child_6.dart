...
class Scenario_missing_child_6_left extends StatefulWidget {
  ...
  @override
  State<Scenario_missing_child_6_left> createState() =>
      _Scenario_missing_child_6_leftState();
}

class _Scenario_missing_child_6_leftState
    extends State<Scenario_missing_child_6_left> {
  @override
  void initState() {
    super.initState();
  }
...
class Scenario_missing_child_6_right extends StatefulWidget {
  ...
  @override
  State<Scenario_missing_child_6_right> createState() =>
      _Scenario_missing_child_6_rightState();
}

class _Scenario_missing_child_6_rightState
    extends State<Scenario_missing_child_6_right> {
  SMIBool? _bool1;
  SMIBool? _bool2;
  ...
  Future<void> _playWelcomeTTS() async {
    ...
    await Provider.of<Scenario_Manager>(context, listen: false)
        .updateSubtitle("가게 안으로 들어왔습니다. 저기 점원 분이 보이네요.\n"
